...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      ...
      {/* Cards */}
      <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 w-3/4'>
      ...
      <div className='flex gap-6 w-3/4'>
        ...
        {/* Recent Bookings */}
        <div className='p-4 md:p-6 border border-borderColor rounded-md w-1/2'>
          <h1 className='text-lg font-medium'>Recent Bookings</h1>
          <p className='text-gray-500'>Latest customer bookings</p>

          {data.recentBookings.length === 0 && (
            <p className='mt-4 text-gray-400'>No bookings available</p>
          )}

          {data.recentBookings
            ?.filter((booking) => booking && booking.car) // ✅ remove null values
            .map((booking, index) => (
        ...
        {/* Monthly Revenue */}
        <div className='p-4 md:p-6 mb-6 border border-borderColor rounded-md w-1/2'>
